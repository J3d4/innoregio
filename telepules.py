...
# inptomb = read.dataframe('/home/jeda/work/innoregio/output/tomb-out.csv')
...
def calculate(telepules, tomb):
    ...
    for i in tqdm(range(len(tomb))):
        for j in range(len(telepules)):
            if tomb[i].Telepules == telepules[j].Telepules:
