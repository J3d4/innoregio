...
def calculate(tomb, telek, epulet):
    ...
    for i in tqdm(range(len(tomb))):
        ...
        if float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L1) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult kis csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L1_M) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo kis csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L2) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult nagy csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L2_M) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo nagy csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L3) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott epult csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L3_F) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980-89 kozott epult csaladi hazakeval megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L4) / float(tomb[i].TT_e)) > 0.4:
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990-2001 kozott epult csaladi haz.'
            jellemzoHelp += 1
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L4_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1990-2001 kozott epult csaladi hazakeval megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett csaladi haz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L5) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 2002 utan epult csaladi haz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L5_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: A 2002 utan epult csaladi hazakeval megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett csaladi haz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L6) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 2002 elott epult kis tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L6_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo kis tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L7) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 2002 utan epult tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L8) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1946 elott epult nagy tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L8_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo nagy tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L9) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1946-2001 kozott epult nagy tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L10_A) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 elott, blokkos epítesi moddal epult tarsashaz, fűtetlen kozos kozlekedovel.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L10_B) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 elott, blokkos epítesi moddal epult tarsashaz, fűtott kozos kozlekedovel.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L11_A) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott, ontottfalas epítesi moddal epult tarsashaz, fűtetlen kozos kozlekedovel.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L11_B) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott, ontottfalas epítesi moddal epult tarsashaz, fűtott kozos kozlekedovel.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L12_A) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott, ontottfalas epítesi moddal epult tarsashaz, fűtetlen kozos kozlekedovel.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L12_B) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott, ontottfalas epítesi moddal epult tarsashaz, fűtott kozos kozlekedovel.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L12_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980-89 kozott, ontottfalas epítesi moddal epult tarsashazakeval megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L13) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 elott, paneles epítesi moddal epult tarsashaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_L13_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1990 elott, paneles epítesi moddal epult tarsashazakeval megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett tarsashaz.'
        
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K1) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult egeszsegugyi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K1_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo egeszsegugyi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K2) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 utan epult egeszsegugyi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K2_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980 utan epult  egeszsegugyi epuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett egeszsegugyi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K3) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult irodaepulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K3_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo irodaepulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K4) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott epult irodahaz.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K4_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980-89 kozott epult irodaepuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett irodaepulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K5) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 utan epult irodaepulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K5_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1990 utan epult irodaepuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett irodaepulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K6) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult kereskedelmi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K6_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo kereskedelmi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K7) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 utan epult kereskedelmi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K7_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980 utan epult kereskedelmi epuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett kereskedelmi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K8) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1946 elott epult kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K8_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K9) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1946-79 kozott epult kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K10) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott epult kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K10_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980-89 kozott epult kulturalis epuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K11) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 utan epult kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K11_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1990 utan epult kulturalis epuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett kulturalis epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K12) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult oktatasi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K12_M) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Műemleki/egyeb vedettseg alatt allo oktatasi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K13) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott epult oktatasi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K13_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1980-89 kozott epult oktatasi epuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett oktatasi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K14) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 utan epult oktatasi epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_K14_F) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Az 1990 utan epult oktatasi epuletekevel megegyezo energetikai teljesítmenyű, de regebbi epítesű, energetikai korszerűsítesen atesett oktatasi epulet.'
        
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_I1A) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult, fűtott ipari epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_I1B) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980 elott epult, temperalt (alacsony fűtesi igenyű) ipari epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_I2A) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott epult, fűtott ipari epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_I2B) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1980-89 kozott epult, temperalt (alacsony fűtesi igenyű) ipari epulet.'
        elif float(tomb[i].TT_e) != 0.0 and (float(tomb[i].T_I3A) / float(tomb[i].TT_e)) > 0.4:
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: 1990 utan epult, fűtott ipari epulet.'
            ...
            jellemzoHelp += 1
            tomb[i].tomb_leiras = 'Tömbre jellemző épülettípus: Egyedi tipusu epulet.'
